...
const PARTS = {
  ...
  fore:  '<path d="M31,88 C29,96 28,108 29,118 C30,122 34,122 36,119 L39,90 Z" fill="BODY"/>',
  thigh: '<path d="M42,97 C40,104 40,110 42,116 L46,152 C47,157 53,157 55,152 L58,116 V97 Z" fill="BODY"/>',
  shin:  '<path d="M47,154 C45,162 45,176 47,188 C48,192 54,192 55,188 C57,176 57,162 56,154 Z" fill="BODY"/>',
};
